                  ...
                  <>
                    ...
                    {showDetail ? (
                      <div className="w-full mt-3">
                        <Tag
                          color="processing"
                          className="p-4 text-[16px] w-full"
                        >
                          نتیجه :<div className="mt-2"></div>
              ...
              <CardStat
                ...
                data={
                  <>
                    <div className="w-full grid grid-cols-4 gap-3 items-end">
                      <InputCom
                        onChenge={(e) => setCardNumber(e.target.value)}
                        type={"req"}
